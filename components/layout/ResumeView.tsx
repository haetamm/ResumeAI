...
import ThResumePreview from "./my-resume/template/ThResumePreview";
import ThSimpleResumePreview from "./my-resume/template/ThSimpleResume";
...
const ResumeView: React.FC<ResumeViewProps> = ({ isOwnerView }) => {
